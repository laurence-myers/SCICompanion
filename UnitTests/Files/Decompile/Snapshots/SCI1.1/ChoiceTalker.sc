...
(class AnimDialog of Dialog
	...
	(method (doit param1 &tmp temp0 temp1 temp2)
		...
		(while (not temp1)
			(cond 
				((IsObject gFastCast) (gFastCast eachElementDo: 57))
				((IsObject gTheDoits) (gTheDoits eachElementDo: 57))
			)
			(= gGameTime (+ gTickOffset (GetTime)))
...
(class ChoiceNarrator of Narrator
	...
	(method (display param1 &tmp theTalkWidth newGWindow temp2 temp3 temp4 temp5 newPrint)
		(if normal
			...
			(if (not normal)
				...
				(while
					(= temp5
						(Message 2 modNum curNoun curVerb curCase temp4)
					)
					(newPrint
...
(class ChoiceTalker of Talker
	...
	(method (display param1 &tmp temp0 theTalkWidth temp2 newGWindow temp4 temp5 temp6 temp7 newPrint)
		(if normal
			(super display: param1 &rest)
		else
			(= newGWindow (gWindow new:))
			...
			(if (not normal)
				...
				(while
					(= temp7
						(Message 2 modNum curNoun curVerb curCase temp6)
					)
					(newPrint
