		...
		(cond 
			(
				...
				(if (== (client view?) vInMotion)
					(cond 
						((and vSlow (IsOneOf stopState 0)) (= stopState 1))
						(
							(and
								vSlow
								(== stopState 4)
						...
						((and (not vSlow) (IsOneOf stopState 0)) (= stopState 3))
						((not (IsOneOf stopState 2 3 1)) (= stopState 4))
					)
			...
			((IsOneOf stopState 4 2 3 1) (if vStart (= stopState 5) else (= stopState 7)))
		)
		(switch stopState
			(0
				(= cycleDir 1)
